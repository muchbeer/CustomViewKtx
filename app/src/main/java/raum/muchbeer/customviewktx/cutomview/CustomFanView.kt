package raum.muchbeer.customviewktx.cutomview
...
class CustomFanView @JvmOverloads constructor(
    context: Context,
   ...
   //     paint.color = if(fanSpeed ==FanSpeed.OFF) Color.GRAY else Color.GREEN
        ...
        //smaller indicator circle below is the code
