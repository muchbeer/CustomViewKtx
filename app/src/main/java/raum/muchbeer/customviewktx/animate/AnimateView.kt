package raum.muchbeer.customviewktx.animate
...
import kotlinx.android.synthetic.main.activity_animate_view.*
import raum.muchbeer.customviewktx.R

class AnimateView : AppCompatActivity() {
    ...
    //alpha relate in graphics container opaque
    private fun fader() {
